// src/utils/ubigeoPeru.js
// Catálogo oficial de Departamentos, Provincias y Distritos del Perú (INEI / RENIEC)
...
export const UBIGEO_PERU = {
  ...
  "Áncash": {
    ...
    "Yungay": ["Yungay", "Cascapara", "Duque de Caxias", "Mache", "Matacoto", "Quillo", "Ranrahirca", "Shupluy", "Yanama"]
  },
  "Apurímac": {
    ...
    "Chincheros": ["Chincheros", "Anco_Huallo", "Cocharcas", "Huaccana", "Ocobamba", "Ongoy", "Uranmarca", "Ranracancha", "Rocchacc", "El Porvenir", "Los Chankas", "Ahuayro"],
    "Grau": ["Chuquibambilla", "Curasco", "Curpahuasi", "Gamarra", "Huayllati", "Mamara", "Mariscal Gamarra", "Micaela Bastidas", "Pataypampa", "Progreso", "San Antonio", "Santa Rosa", "Turpay", "Vilcabamba", "Virundo"]
  },
  "Arequipa": {
    "Arequipa": ["Arequipa", "Alto Selva Alegre", "Cayma", "Cerro Colorado", "Characato", "Chiguata", "Jacobo Hunter", "La Joya", "Mariano Melgar", "Miraflores", "Mollebaya", "Paucarpata", "Pocsi", "Polobamba", "Quequeña", "Sabandia", "Sachaca", "San Juan de Siguas", "San Juan de Tarucani", "Santa Isabel de Siguas", "Santa Rita de Siguas", "Socabaya", "Tiabaya", "Uchumayo", "Vitor", "Yanahuara", "Yarabamba", "Yura", "José Luis Bustamante y Rivero"],
  ...
  "Cajamarca": {
    ...
    "Chota": ["Chota", "Anguía", "Chadin", "Chiguirip", "Chimban", "Choropampa", "Cochabamba", "Conchán", "Huambos", "Lajas", "Llama", "Miracosta", "Paccha", "Pión", "Querocoto", "San Juan de Licupis", "Tacabamba", "Tocmoche", "Chalamarca"],
  ...
  "Cusco": {
    ...
    "La Convención": ["Santa Ana", "Echarate", "Huayopata", "Inkawasi", "Kimbiri", "Maranura", "Megantoni", "Ocobamba", "Pichari", "Quellouno", "Santa Teresa", "Vilcabamba", "Villa Kintiarina", "Villa Virgen", "Cielo Punco", "Manitea", "Kumpirushiato", "Unión Asháninka"],
  ...
  "Huánuco": {
    ...
    "Leoncio Prado": ["Rupa-Rupa", "Daniel Alomía Robles", "Hermilio Valdizán", "José Crespo y Castillo", "Luyando", "Mariano Dámaso Beraún", "Pucayacu", "Castillo Grande", "Pueblo Nuevo", "Santo Domingo de Anda", "San Pablo de Pillao"],
  ...
  "Lima": {
    ...
    "Yauyos": ["Yauyos", "Alis", "Allauca", "Ayaviri", "Azángaro", "Cacra", "Carania", "Catahuasi", "Chocos", "Cochas", "Colonia", "Carangas", "Huampara", "Huancaya", "Huangascar", "Huantan", "Huañec", "Laraos", "Lincha", "Madean", "Miraflores", "Omas", "Putinza", "Quinches", "Quinocay", "San Joaquín", "San Pedro de Pilas", "Tanta", "Tauripampa", "Tomas", "Tupe", "Viñac", "Vitis"]
  },
  "Loreto": {
  ...
  "Piura": {
    ...
    "Sechura": ["Sechura", "Bellavista de la Unión", "Bernal", "Cristo Nos Valga", "Vice", "Rinconada Llícuar"]
  },
  "Puno": {
  ...
  "San Martín": {
    ...
    "Rioja": ["Rioja", "Awajún", "Elías Sópalo", "Nueva Cajamarca", "Pardo Miguel", "Posic", "San Fernando", "Yorongos", "Yuracyacu"],
  ...
  "Ucayali": {
    ...
    "Padre Abad": ["Padre Abad", "Irazola", "Curimaná", "Neshuya", "Alexander Von Humboldt", "Boquerón", "Huipoca"],
    "Purús": ["Purús"]
  }
}
...
export function esPeru(pais) {
  if (!pais) return true
  const p = pais.trim().toLowerCase()
  return p === "perú" || p === "peru"
}

export function getDepartamentos() {
  return Object.keys(UBIGEO_PERU).map((dep) => ({ value: dep, label: dep }))
}

export function getProvincias(departamento) {
  if (!departamento || !UBIGEO_PERU[departamento]) return []
  return Object.keys(UBIGEO_PERU[departamento]).map((prov) => ({
    value: prov,
    label: prov,
  }))
}

export function getDistritos(departamento, provincia) {
  if (
    !departamento ||
    !provincia ||
    !UBIGEO_PERU[departamento] ||
    !UBIGEO_PERU[departamento][provincia]
  ) {
    return []
  }
  return UBIGEO_PERU[departamento][provincia].map((dist) => ({
    value: dist,
    label: dist,
  }))
}
